            ...
            <div id="content">
                ...
                <div class="container-fluid">
                  ...
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Community</h1>
                    </div>
                      ...
                      <div class="swiper-reviews-carousel overflow-hidden">
                        <div class="swiper" id="swiper-reviews">
                          <div class="text-center">
                            <small class="btn btn-primary mb-2 btn-sml" data-toggle="modal" data-target="#post">Write a Post <i class="ti fw-bold ti-pencil-share ms-1 ti-14px"></i></small>
                          </div>
                              ...
                              <div class="swiper-slide mb-2">
                                <div class="card h-100">
                                  <div class="card-body text-body d-flex flex-column justify-content-between h-100">
                                    <div class="mb-4">
                                      <small class="btn btn-warning btn-sml position-absolute" style="right: 10px" data-toggle="modal" data-target="#commentModal{{$post->id}}">Comment <i class="ti fw-bold ti-message-plus ms-1 ti-14px"></i></small>
                                      <div class="d-flex align-items-center">
                                        <div class="avatar me-3 avatar-sm">
                                          <img src="{{asset('assets/img/avatars/1.png')}}" alt="Avatar" class="rounded-circle" style="width: 40px; height: 40px; margin-right: 10px;" />
                                        </div>
                                        <div>
