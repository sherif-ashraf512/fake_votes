                ...
                <div class="container-fluid">
                  ...
                  <div class="d-sm-flex align-items-center justify-content-between mb-4">
                    ...
                    <div class="text-center">
                      <button type="button" class="btn mb-2 btn-primary" data-toggle="modal" data-target="#addVoteModal"><i class="ti ti-plus"></i> Add Vote</button>
                    </div>
                    @if ($errors->any())
                                  ...
                                  <div class="mb-4 d-flex">
                                    ...
                                    <div class="position-absolute" style="right: 10px">
                                      <div class="d-inline-block text-nowrap">
                                        ...
                                        <button data-target="#deleteVoteModal{{$vote->id}}" data-toggle="collapse"
                                          aria-expanded="true" aria-controls="deleteVoteModal{{$vote->id}}" class="btn collapsed btn-sm btn-icon btn-text-secondary rounded-pill waves-effect waves-light dropdown-toggle hide-arrow" data-bs-toggle="dropdown">
                                            <i class="ti ti-dots-vertical ti-md"></i>
                                        </button>
                                        <div id="deleteVoteModal{{$vote->id}}" class="dropdown-menu collapse dropdown-menu-end m-0">
