  ...
  <div class="container">
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li>
          @if (Auth()->check())
          <a href="{{route('logout')}}" class="btn btn-primary"><span class="tf-icons ti ti-logout scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Logout</span></a>
          @else
          <a href="{{route('login-page')}}" class="btn btn-primary"><span class="tf-icons ti ti-login scaleX-n1-rtl me-md-1"></span><span class="d-none d-md-block">Login/Register</span></a>
          @endif
        </li>
        <!-- navbar button: End -->
      </ul>
